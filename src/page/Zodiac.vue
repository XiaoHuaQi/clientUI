<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <div>
        <banner></banner>
        <van-field readonly clickable label="分类" :value="value" placeholder="选择分类" @click="showPicker = true" />
       ...
       <!-- <van-image  src="http://47.104.202.152//ftpnginx/company/a469eb2bef498bea282913ed39b8d5d6.jpg" fit="contain"  width="100%" height="100%"/>-->
        ...
        <van-list v-model="loading" :finished="finished" finished-text="没有更多了" @load="onLoad" >
            <van-grid :gutter="2" class="mgtop20" :column-num="2" v-for="item in list" :key="item" :title="item">
